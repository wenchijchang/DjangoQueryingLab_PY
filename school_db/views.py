...
def problem_five(request):
  p = Student.objects.create(first_name='Jennifer', last_name='Chang', year=12, gpa=4.0)
...
def problem_six(request):
  ...
  new_gpa = Student.objects.filter(id=12).update(gpa=3.8)
  updated_gpa_student = Student.objects.get(id=12)
  print(f'Id: {updated_gpa_student.id}\nFull Name: {updated_gpa_student.first_name} {updated_gpa_student.last_name}\nYear: {updated_gpa_student.year}\nGPA: {updated_gpa_student.gpa}')
  return complete(request)
